...
public class JXLclass {
	...
	public static void main(String[] args) throws Exception {
		...
		File f = new File("C:\\Users\\pautp\\Desktop\\exercise1.xlsx");
		...
		for (int i = 1; i < cour; i++) {
			...
			try {
				if (m.equals("") && ExpectedConditions.alertIsPresent() != null) {
					...
					wsh.addCell(l5);
				} else if (mc.equals("invalid")
						&& driver
								.findElement(
										By.xpath("//*[contains(text(),'registered yet')]"))
								.isDisplayed()) {
					...
					wsh.addCell(l3);
				} else if (mc.equals("valid")
						&& pc.equals("invalid")
						&& driver.findElement(By.xpath("//*[@id='sms']"))
								.isDisplayed()) {
