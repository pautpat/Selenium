...
*/
	...
	// SendKeys Method of Actioon class
		driver.get("http://www.gmail.com");
		Thread.sleep(3000);
		driver.manage().window().maximize();
		Thread.sleep(3000);
		WebElement gElement = driver.findElement(By.name("identifier"));
		
		Thread.sleep(3000);
		Actions a = new Actions(driver);
		a.click(gElement).sendKeys("abc@gmail.com").build().perform(); // Filling the Element using Actions Class
		Thread.sleep(3000);
		driver.close();
