...
*/
	...
	// How to handle frame elements
		...
		driver.manage().window().maximize();
		Thread.sleep(3000);
		WebElement gElement = driver.findElement(By.className("gb_P"));
		// Code to get a list of frames in your web page
		Actions a = new Actions(driver);
		a.click(gElement).build().perform(); // Every action class method needs an argument and need to call .build().perform() methods
		Thread.sleep(3000);
