...
*/
	...
	// How to handle frame elements
		...
		// Switch to the current frame where element is located
		Thread.sleep(3000);
		for(WebElement frameList : list){
			System.out.println(frameList.getAttribute("name"));
		}
		Thread.sleep(3000);
		...
		// Come back from Frame to our current web pagesince you cannot switch from 1 frame to other frame directly
